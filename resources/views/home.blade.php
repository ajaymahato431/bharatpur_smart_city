    ...
    <div class="bg-white page-content">
                ...
                <div id="rev_slider_486_1" class="rev_slider fullwidthabanner" style="display:none;"
                    ...
                    <ul> <!-- SLIDE  -->
                        @foreach ($heroSections as $herosection)
                            <li>
                                <!-- MAIN IMAGE -->
                                <img src="{{ Storage::url($herosection->featured_image) }}" alt=""
                                ...
                                <!-- LAYER NR. 4 -->
                                <a href="{{ $herosection->button2_link }}">
                                ...
                                <a href="{{ $herosection->button1_link }}">
        ...
        <div class="content-block">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="service-bx">
                                ...
                                <div class="text-center info-bx">
                                    <div class="bg-white feature-box-sm radius">
            ...
            <div class="section-area section-sp1 ovpr-dark bg-fix online-cours"
                ...
                <div class="container">
                    <div class="row">
                        <div class="text-center text-white col-md-12">
            ...
            <div class="section-area section-sp2">
                <div class="container">
                    <div class="row">
                        <div class="text-center col-md-12 heading-bx">
            ...
            <div class="section-area section-sp2 bg-fix ovbl-dark"
                ...
                <div class="container">
                    <div class="row">
                        <div class="text-white col-md-12 heading-bx left">
